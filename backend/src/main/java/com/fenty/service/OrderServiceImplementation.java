...
import com.fenty.repository.AddressRepository;
import com.fenty.repository.CartRepository;
import com.fenty.repository.OrderItemRepository;
import com.fenty.repository.OrderRespository;
...
public class OrderServiceImplementation implements OrderService {
	...
	public OrderServiceImplementation(OrderRespository orderRepository,
	...
	public Order createOrder(User user, Address shippAddress) {
		...
		for (CartItem item : cart.getCartItems()) {
			...
			orderItem.setDiscountedPrice(item.getDicountedPrice());
